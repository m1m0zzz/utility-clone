...
class KnobSlider : public juce::Slider {
 public:
  ...
  KnobSlider(juce::LookAndFeel* lookAndFeel, CustomPopupMenu& menu,
             bool disabled = false)
      : disabled(disabled), menu(menu) {
    setSliderStyle(juce::Slider::SliderStyle::RotaryVerticalDrag);
    setTextBoxStyle(juce::Slider::TextEntryBoxPosition::TextBoxBelow, false, 80,
                    20);
  ...
  void updateColourAll() {
    ...
    if (!disabled) {
      ...
      setColour(juce::Label::ColourIds::outlineWhenEditingColourId,
                themeColours.at("white"));
    } else {
      setColour(juce::Slider::ColourIds::thumbColourId,
                themeColours.at("disabled"));
      setColour(juce::Slider::ColourIds::rotarySliderOutlineColourId,
                themeColours.at("disabled"));
      setColour(juce::Slider::ColourIds::rotarySliderFillColourId,
                themeColours.at("white"));
