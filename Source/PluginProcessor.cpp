...
double UtilityCloneAudioProcessor::getTailLengthSeconds() const { return 0.0; }
...
int UtilityCloneAudioProcessor::getCurrentProgram() { return 0; }
...
void UtilityCloneAudioProcessor::processBlock(juce::AudioBuffer<float>& buffer,
